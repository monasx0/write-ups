...
$ git log
````
Alternatively, navigate to the repository's Commits section on GitHub, open the most recent commit, and append `.patch` to the URL. The developer's email address will be visible in the commit details.
